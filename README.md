...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m3u2-sc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m3u2-sc.containers.anotherwebservice.com/
...
```
git clone git@github.com:thoai112/smarthome.git
cd container-m3u2-sc
```
...
```
docker attach container-m3u2-sc
```
